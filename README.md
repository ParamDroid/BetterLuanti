<div align="center">
    ...
    <h1>BetterLuanti (fork of Minetest/Luanti)</h1>
...
<br>
**BetterLuanti** is a custom fork of the Luanti (formerly Minetest) engine, focused on improving the experience for mobile platforms, especially Android.

This project aims to provide:

- Better touch controls and UI improvements  
- Mobile-focused optimizations and performance tweaks  
- Easier gameplay features and quality-of-life enhancements  
- Compatibility with existing Luanti servers and mods  
- A cleaner, more modern experience for handheld devices  

BetterLuanti stays close to upstream Luanti development while adding features designed specifically for mobile players.
